...
class RectangularRoom(object):
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return len([x for x in self.tiles.values() if x])
    ...
    def getRandomPosition(self):
        ...
        """
        return Position(*random.choice(list(self.tiles.keys())))
...
#print(runSimulation(1, 1.0, 5, 5, 1, 3000, StandardRobot))
...
# === Problem 6
# A slightly more interesting graph representation
pylab.xkcd()
